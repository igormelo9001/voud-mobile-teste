...
// consts
const reduxFormName = "legalPurchaseForm";
...
// Component
class LEGALPurchaseForm extends Component {
  constructor(props) {
    super(props);
    this.promoCode = null;
  }
    ...
    return (
      <View style={style}>
        ...
        <BuySummary
          ...
          valid={valid}
          productType={productTypes.LEGAL}
...
export default connect(mapStateToProps)(
  reduxForm({ form: reduxFormName, destroyOnUnmount: false })(LEGALPurchaseForm)
);
