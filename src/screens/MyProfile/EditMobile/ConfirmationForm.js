...
const reduxFormName = 'mobileConfirmation';
...
class ConfirmationForm extends Component {
  ...
  _fillCode = (code) => {
    this.props.change('verificationCode', code);
    this._submit();
  };
  ...
  render() {
    const { style, ui, mobile, valid, onResend, onEdit } = this.props;
      ...
      <FadeInView style={style}>
        <View style={styles.warningBox}>
          ...
          <BrandText style={styles.warningText}>
            Informe o código enviado para o número acima
                    </BrandText>
        </View>
...
export default connect(mapStateToProps)(reduxForm({ form: reduxFormName, destroyOnUnmount: false })(ConfirmationForm));
