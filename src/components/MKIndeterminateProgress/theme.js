...
const firstColorRef = new AttrReference('firstColor');
...
//
Object.assign(theme, {
  firstColor: MKColor.Indigo,
  firstColorRGB: MKColor.RGBIndigo,
  ...
  textfieldStyle: {
    ...
    highlightColor: new RGBAttrReference('firstColorRGB', 0.9),
    textInputStyle: {
  ...
  progressStyle: {
    backgroundColor: new RGBAttrReference('firstColorRGB', 0.3),
    progressColor: firstColorRef,
    bufferColor: new RGBAttrReference('firstColorRGB', 0.3),
  },
  spinnerStyle: {
    strokeColor: [
  ...
  sliderStyle: {
    lowerTrackColor: firstColorRef,
    upperTrackColor: '#cccccc',
  },
  iconToggleStyle: {
    onColor: new RGBAttrReference('firstColorRGB', 0.4),
  ...
  switchStyle: {
    onColor: new RGBAttrReference('firstColorRGB', 0.4),
    offColor: 'rgba(0, 0, 0, 0.25)',
    thumbOnColor: firstColorRef,
    thumbOffColor: MKColor.Silver,
    rippleColor: new RGBAttrReference('firstColorRGB', 0.2),
  },
  radioStyle: {
    borderOnColor: firstColorRef,
    borderOffColor: firstColorRef,
    fillColor: firstColorRef,
    rippleColor: new RGBAttrReference('firstColorRGB', 0.2),
  },
  checkboxStyle: {
    borderOnColor: firstColorRef,
